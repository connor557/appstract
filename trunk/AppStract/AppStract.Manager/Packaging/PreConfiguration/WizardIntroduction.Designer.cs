...
namespace AppStract.Manager.Packaging.PreConfiguration
{
  partial class WizardIntroduction
  {
    ...
    private void InitializeComponent()
    {
      ...
      this._labelHeader.Size = new System.Drawing.Size(397, 48);
      this._labelHeader.TabIndex = 0;
      this._labelHeader.Text = "Welcome to the New Portable Application\r\nWizard";
      // 
      // _labelContent
      // 
      ...
      this._labelContent.Size = new System.Drawing.Size(364, 91);
      this._labelContent.TabIndex = 1;
      this._labelContent.Text = resources.GetString("_labelContent.Text");
      // 
      // WizardIntroduction
      // 
