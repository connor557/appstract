...
namespace AppStract.Server.Hooking
{
  ...
  /// </summary>
  public class RegistryHookProvider : HookProvider
  {
    ...
    /// </summary>
    private class RegistryHookHandler : HookHandler
    {
    ...
    /// </summary>
    private readonly RegistryHookHandler _hookHandler;
    ...
    public RegistryHookProvider(IRegistryProvider registryProvider)
    {
      ...
      _hookHandler = new RegistryHookHandler(registryProvider);
    }
